...
export function PreviewPanel({ artifact, htmlContent, markdownContent }: PreviewPanelProps) {
  ...
  return (
    <div
      className={`flex flex-col h-full bg-[#0d121f] border border-[#232d45] rounded-xl overflow-hidden transition-all ${
        isFullscreen ? 'fixed inset-4 z-50 shadow-2xl bg-[#060911]' : ''
      }`}
    >
      <div className="px-4 py-2.5 border-b border-[#232d45] flex items-center justify-between bg-[#151c2e]/50">
