  ...
  return (
    <div className="flex flex-col h-full bg-[#0d121f] border border-[#232d45] rounded-xl overflow-hidden">
      <div className="px-4 py-3 border-b border-[#232d45] flex items-center justify-between bg-[#151c2e]/50">
        <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-300">Generated Artifacts</h3>
        <span className="text-[11px] font-mono text-cyan-400">{artifacts.length} Files</span>
      </div>
              ...
              <div
                ...
                className={`p-2.5 rounded-lg border transition-all flex items-center justify-between gap-3 ${
                  isSelected
                    ...
                    : 'bg-[#151c2e]/50 border-[#232d45]/70 hover:border-slate-700'
                }`}
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h5 className="text-xs font-medium text-slate-200 truncate">{art.name}</h5>
