  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[var(--background)] text-[var(--foreground)] overflow-hidden p-6 transition-colors duration-200">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-[var(--foreground)] tracking-tight">Artifacts & Deliverables</h1>
        ...
        {isLoading ? (
          ...
          filtered.map((art) => {
            ...
            return (
              <div
                key={art.id}
                className="p-4 rounded-2xl bg-[var(--surface-secondary)] border border-[var(--border)] hover:border-[#06B6D4]/40 transition-all flex flex-col justify-between group asura-card-interactive shadow-xs"
              >
                <div>
                  <div className="w-10 h-10 rounded-xl bg-[var(--surface)] border border-[var(--border)] flex items-center justify-center mb-3">
                  ...
                  <div className="text-[11px] text-[var(--muted-foreground)] mt-1 flex items-center gap-2">
                    <span className="font-mono text-[10px] px-1.5 py-0.2 bg-[var(--surface)] rounded border border-[var(--border)] uppercase">
                      {art.type}
                    </span>
                ...
                <div className="mt-4 pt-3 border-t border-[var(--border)] flex items-center justify-end gap-1.5">
                  {onPreviewArtifact && (
                    <button
